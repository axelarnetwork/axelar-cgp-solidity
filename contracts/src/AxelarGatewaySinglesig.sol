...
contract AxelarGatewaySinglesig is IAxelarGatewaySinglesig, AxelarGateway {
    ...
    bytes32 internal constant PREFIX_OPERATOR_INDEX =
    ...
    function _execute(bytes memory data, bytes memory sig) internal {
        ...
        for (uint256 i = 0; i < commandsLength; i++) {
            ...
            if (commandHash == SELECTOR_DEPLOY_TOKEN) {
                ...
                commandSelector = AxelarGatewaySinglesig
                    .transferOwnership
                    .selector;
    ...
    function deployToken(address signer, bytes memory params)
        external
        onlySelf
    {
        (
    ...
    function transferOwnership(address signer, bytes memory params)
        external
        onlySelf
    {
    ...
    function transferOperatorship(address signer, bytes memory params)
        external
        onlySelf
    {
